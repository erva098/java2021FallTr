...
public class C05_indexOf {
    public static void main(String[] args) {
        ...
        System.out.println(str1.indexOf("aska"));//10 tek string olarak dusunur ilk harfi gorunce onu dondurur
        ...
        //(inclusive)besinci satiri dahil ederek basla demek
        ...
        //OZET: indexof method'u icerisine yazilan string veya char'in metinde hangi index'de
        //oldugunu bize dondurur
        //eger aradigimiz metin veya char yoksa ,olmadiginin delili olarak bize -1 dondurur
