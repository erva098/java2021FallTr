...
public class C01_MDArrays {
    public static void main(String[] args) {
        ...
        //ilk inner array'in tum elementlerini yazdirin dersek
        System.out.println(arr[0]); //arr[0] array oldugundan direk yazdiramayiz
        System.out.println(Arrays.toString(arr[0]));//[3, 1, 7]


        System.out.println(Arrays.toString(arr)); //[[I@58372a00, [I@4dd8dc3]

        //MDArray'de tum elemetleri bir array olarak yazdirmak istersek
